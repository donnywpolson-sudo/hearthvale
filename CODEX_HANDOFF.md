...
* Protected-term search found only policy text, validation guard code/tests, and legacy save migration/test aliases; active data drift was not found in the targeted search.
